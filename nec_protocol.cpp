 ...
 */
// static inline
bool NecProtocol::nec_check_in_range(uint32_t signal_duration, uint32_t spec_duration)
{
 ...
 */
// static
bool NecProtocol::nec_parse_logic0(rmt_symbol_word_t *rmt_nec_symbols)
{
 ...
 */
// static
bool NecProtocol::nec_parse_logic1(rmt_symbol_word_t *rmt_nec_symbols)
{
 ...
 */
//static
bool NecProtocol::nec_parse_frame(rmt_symbol_word_t *rmt_nec_symbols)
{
 ...
 */
// static
bool NecProtocol::nec_parse_frame_repeat(rmt_symbol_word_t *rmt_nec_symbols)
{
...
void NecProtocol::receiveNecFrame(
...
void NecProtocol::transmitNecRepeatFrame(
         rmt_channel_handle_t tx_channel)
{
